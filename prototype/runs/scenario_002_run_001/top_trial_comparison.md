...
| 2 | `NCT04105270` | 10/10 | PHASE2 | Oral Restorative Microbiota Therapy (RMT) Capsules, Durvalumab 1500 mg IV, Cisplatin/pemetrexed or Carboplatin/pemetrexed, Placebo | Number of patients experiencing Progression Free Survival (PFS); 3 Years | Histologically or cytologically confirmed adenocarcinoma of the lung that is unresectable stage IIIB/C or stage IV, does not have an EGFR sensitizing (activating) muta... | RECIST: RECIST 1.1; Stage: unresectable, stage IIIB; Biomarker: EGFR sensitizing (activating) mutation or ALK or ROS1 translocation, mutation * Measurable disease based on RECIST 1 | recist, measurable, pd-l1, egfr, alk, ros1 |
| 3 | `NCT04691817` | 10/10 | PHASE1, PHASE2 | Atezolizumab, Tocilizumab | Overall response rate (ORR); From first dose of protocol treatment until radiologic disease assessment at 12 weeks. | ECOG PS 0-2 Exclusion Criteria: | ECOG: ECOG PS 0-2; Timing: at 12 weeks, up to 24 months; Stage: Stage IV; Biomarker: mutation that is susceptible to targeted therapy * No greater than CTCAE v5 grade 3 toxi; Safety: autoimmune disease or IPF | ecog, autoimmune |
| 4 | `NCT04984811` | 10/10 | PHASE2 | efineptakin alfa, Atezolizumab | Objective Response Rate (ORR); The first on-study imaging assessment were performed every 6 weeks for the first 6 months and every 9 weeks, or more frequently if clini... | Tumor PD-L1 expression (TPS>=1%) as determined by PD-L1 22C3 immunohistochemistry local or central assay. | ECOG: ECOG 0-1; PD-L1: PD-L1 expression (TPS>=1%); Timing: every 6 weeks, every 9 weeks; Stage: metastatic, locally advanced; Biomarker: PD-L1 expression (TPS>=1%) as determined by PD-L1 22C3 immunohistochem... | ecog, measurable, pd-l1, egfr, alk |
| 5 | `NCT05344209` | 10/10 | PHASE2 | UV1, Sagramostim, Anti-PD-1/PD-L1 treatment | Progression-free survival (PFS) per Response Evaluation Criteria in Solid Tumours (RECIST 1.1) as determined by Blinded Independent Central Review (BICR); Up to 2 years | Histologically confirmed NSCLC stage IIIB/IIIC or IV not amenable for curative treatment, with PD-L1 >= 50% measured by a validated method, and eligible for pembrolizu... | PD-L1: PD-L1 >= 50%; RECIST: RECIST 1.1; Timing: Up to 2 years; Stage: stage IIIB, metastatic; Biomarker: PD-L1 >= 50% measured by a validated method | recist, pd-l1 |
