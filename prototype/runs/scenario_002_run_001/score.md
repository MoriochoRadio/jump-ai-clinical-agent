...
| Similar-Trial And Evidence Awareness | 10 | 10 | Uses live ClinicalTrials.gov retrieval, PubMed metadata retrieval, PubMed abstract screening signals, de-duplication, local ranking, and candidate-review files without inventing trial or article results. |
...
| Report Structure And Traceability | 10 | 10 | Clear pre-review packet structure with checklist, ranked sources, PubMed candidate review, abstract-screening signals, data-readiness table, limitations, and follow-up questions. |
