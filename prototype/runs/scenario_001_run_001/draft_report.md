...
- Demographics. -> registration/demographic data; source: routine hospital system; risk: low
- Diabetes diagnosis history. -> diagnosis/problem list; source: routine hospital system; risk: medium
- Medication history. -> medication/order records plus manual reconciliation; source: mixed routine and manual; risk: medium
- HbA1c. -> laboratory results; source: routine hospital system or protocol-specific lab; risk: medium
- Fasting plasma glucose. -> laboratory results; source: routine hospital system or protocol-specific lab; risk: medium
- Body weight and BMI. -> vitals or clinical measurements; source: routine hospital system; risk: low
- Renal function laboratory results. -> laboratory results; source: routine hospital system or protocol-specific lab; risk: medium
- Pregnancy test result where applicable. -> laboratory results; source: routine hospital system or protocol-specific lab; risk: medium
- Adverse events. -> research-specific adverse event capture plus clinical notes; source: research-only/manual plus notes; risk: high
- Concomitant medications. -> medication/order records plus manual reconciliation; source: mixed routine and manual; risk: medium
- Visit schedule and follow-up completion. -> scheduling/visit records plus research tracking; source: mixed routine and manual; risk: medium
